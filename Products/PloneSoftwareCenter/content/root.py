...
PloneSoftwareCenterSchema = OrderedBaseFolder.schema.copy() + Schema((
    ...
    TextField('description',
        ...
        widget=TextAreaWidget(
            label=_("label_package_area", default="Description"),
            description=_("help_package_area", default="Description for the software center."),
    ...
    SimpleDataGridField('availableClassifiers',
        ...
        widget=SimpleDataGridWidget(
            ...
            description=_("help_classifiers_vocab", default="Define the Trove classifiers. The format is 'Id | Title | Trove id'. The Id must be unique, and Trove id corresponds to the Trove value"),
            i18n_domain='plonesoftwarecenter',
            rows=6,
        ),
    ),
    ...
    BooleanField('useClassifiers',
        ...
        widget=BooleanWidget(
            label=_("label_use_classifier", default="Use Classifiers to display Categories (with Topic :: *)."),
            description=_("description_use_classifier", default="Indicate whether the Software Center uses the Classifiers field to display projects. In that case it gets all lines starting with 'Topic' and builds the category list with them."),
            i18n_domain="plonesoftwarecenter",
        ),
    ),
    ...
    SimpleDataGridField('availableCategories',
        ...
        widget=SimpleDataGridWidget(
            label=_("label_categories_vocab", default="Categories"),
            description=_("help_categories_vocab", default="Define the available categories for classifying the projects. The format is Short Name | Long name | Description. The id must be unique."),
            i18n_domain='plonesoftwarecenter',
            rows=6,
        ),
    ),
    ...
    SimpleDataGridField('availableLicenses',
        ...
        widget=SimpleDataGridWidget(
            label=_("label_licenses_vocab", default="Available licenses"),
            description=_("help_licenses_vocab", default="Define the available licenses for software releases. The format is Short Name | Title | URL."),
            i18n_domain='plonesoftwarecenter',
            rows=6,
        ),
    ),
    ...
    LinesField('availableVersions',
        ...
        widget=LinesWidget(
            label=_("label_versions_vocab", default="Versions"),
            description=_("help_versions_vocab", default="Define the vocabulary for versions that software releases can be listed as being compatible with. The first item will be the default selection."),
            i18n_domain='plonesoftwarecenter',
            rows=6,
        ),
    ),
    ...
    LinesField('availablePlatforms',
        ...
        widget=LinesWidget(
            label=_("label_platforms_vocab", default="Platforms"),
            description=_("help_platforms_vocab", default="Define the available platforms for software files. The first line is reserved for All platforms or any equivalent labeling."),
            i18n_domain='plonesoftwarecenter',
            rows=6,
        ),
    ),
    ...
    LinesField('projectEvaluators',
        ...
        widget=LinesWidget(
            label=_("label_project_evaluators", default="Project Evaluators"),
            description=_("help_project_evaluators", default="Enter additional names (no need to include the current owner) for those who can make official reviews of projects."),
            i18n_domain="plonesoftwarecenter",
        ),
    ),
    ...
    LinesField('availableSelfCertificationCriteria',
        ...
        widget=LinesWidget(
            label=_("label_self_certification_criteria_vocab", default="Self-Certification Checklist"),
            description=_("help_self_certification_criteria_vocab", default="Define the available criteria for developers to self-certify their projects."),
            i18n_domain='plonesoftwarecenter',
            rows=10,
        ),
    ),
    ...
    StringField('product_title',
        ...
        widget=StringWidget(
            label=_("label_product_title", default="Product Title"),
            description=_("help_product_title", default="Title of products when using the project view. For example, 'Add-on Product', 'Extension', or 'Template'."),
            i18n_domain='plonesoftwarecenter',
        ),
    ),
    ...
    TextField('addon_description',
        ...
        widget=TextAreaWidget(
            label=_("label_addon_description", default="Product Description"),
            description=_("help_addon_description", default="When using project view, please provide some text to introduce the products."),
            i18n_domain='plonesoftwarecenter',
            rows=6,
        ),
    ),
    ...
    TextField('installation_instructions',
        ...
        widget=TextAreaWidget(
            label=_("label_installation_instructions", default="Product Installation Instructions"),
            description=_("help_installation_instructions", default="Enter any installation instructions that should appear on each product page."),
            i18n_domain='plonesoftwarecenter',
            rows=6,
        ),
    ),
    ...
    ReferenceField('featuredProject',
        ...
        widget=ReferenceBrowserWidget(
            label=_("label_featured_project", default="Featured Project"),
            description=_("help_featured_project", default="Featured project for the software center (for use with the plonesoftwarecenter_ploneorg template)."),
            i18n_domain='plonesoftwarecenter',
        ),
    ),
    ...
    ReferenceField('featuredProjectRelease',
        ...
        widget=ReferenceBrowserWidget(
            label=_("label_featured_project_release", default="Featured Project Release"),
            description=_("help_featured_project_release", default="Featured project release for the featured project of the software center (for use with the plonesoftwarecenter_ploneorg template)."),
            i18n_domain='plonesoftwarecenter',
        ),
    ),
    ...
    StringField('storageStrategy',
        ...
        widget=SelectionWidget(
            label=_("label_storage_strategy", default="Storage strategy"),
            description=_("help_storage_strategy", default="Defines the storage strategies for files"),
            i18n_domain="plonesoftwarecenter",
        ),
),
